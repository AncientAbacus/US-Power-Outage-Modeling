...
When computing the minimum RSME, this number came out to be better than our baseline with a fold of 1. We then fit our final model to compute the fairness analysis.
